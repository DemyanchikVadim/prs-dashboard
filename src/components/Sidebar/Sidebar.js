        ...
        <nav className="sidebar-nav">
          <ul className="nav">
            <li className="nav-item">
              <Link to={'/dashboard'} className="nav-link" activeClassName="active"> <i className="fa fa-automobile fa-lg mt-4"></i> Главная</Link>
            </li>
            <li className={this.activeRoute("/reports")}>
              <a className="nav-link nav-dropdown-toggle" href="#" onClick={this.handleClick.bind(this)}><i className="icon-puzzle"></i> Заявки</a>
              <ul className="nav-dropdown-items">
                <li className="nav-item">
                  <Link to={'/reports/one'} className="nav-link" activeClassName="active"><i className="icon-puzzle"></i> На переходе</Link>
                </li>
              </ul>
            </li>
            <li className="nav-item">
              <Link to={'/rules'} className="nav-link" activeClassName="active"><i className="icon-calculator"></i> Инструкции</Link>
            </li>
            <li className="nav-item">
